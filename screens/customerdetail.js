...
import { StyleSheet, Text, View, Modal, TouchableHighlight,
    ScrollView, Button, TextInput } from 'react-native';
      ...
      return (
        <View>
          ...
          >
            ...
            <View style={{ flex: 1, flexDirection: 'row', alignItems: 'flex-start', maxHeight: 30 }}>
