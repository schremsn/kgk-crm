...
import { StyleSheet, Text, View, Button, FlatList, NativeModules, RTCEventEmitter} from 'react-native';
...
export default class App extends React.Component {
  constructor(props) {   
    ...
    this.dataprovider.login( 'admin', 'zaq12wsx')
      .then( result => {
  ...
  login() {
    ...
    this.dataprovider.login({ username: 'admin', password: 'zaq12wsx' })
      .then( data => {
