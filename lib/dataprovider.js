...
export default class DataProvider {
  ...
  getLead(id) {
    ...
    const params = {
      ...
      fields: ['contact_name', 'name', 'title_action', 'phone', 'partner_name', 'mobile', 'city', 'type', 'email_from', 'id', 'description',
        'lost_reason', 'zip', 'street', 'street2', 'function', 'stage_id', 'tag_ids', 'probability'],
    };
  ...
  */
  getActivities(index = 0) {
    const params = {
      domain: [['active', '=', 'true'], ['activity_summary', '!=', ''],
        ['activity_type_id', 'in', [1, 2, 6]],
        ['user_id', '=', this.getUserId()],
      ],
      fields: ['contact_name', 'date_action', 'name', 'activity_summary', 'phone',
  ...
  /**
   * get a list of messages linked to leads
   * @return {Promise}
   */
  getLeadMessages() {
    const params = {
